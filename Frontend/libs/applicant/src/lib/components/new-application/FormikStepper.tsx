...
interface FormikStepWithValueProps
  extends Pick<
    FormikConfig<FormikValues>,
    'children' | 'validationSchema' | 'initialValues'
  > {}

export function FormikStepWithValue({
  children,
  initialValues,
}: FormikStepWithValueProps) {
  return <>{children}</>;
}
...
export function FormikStepper({
  children,
  ...props
}: { children: ReactNode } & FormikConfig<FormikValues> & FormikStepperProps) {
